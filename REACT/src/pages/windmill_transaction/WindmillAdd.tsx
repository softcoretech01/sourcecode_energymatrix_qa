...
const handleSave = async () => {
  const unitsValue = units === "" ? undefined : parseFloat(units?.toString() || "");
  if (!windmillNumber) {
    toast({ title: "Windmill required", description: "Please select a windmill before saving.", variant: "destructive" });
    return;
  }
  if (units !== "" && isNaN(unitsValue as number)) {
    toast({ title: "Invalid units", description: "Please enter a valid numeric value for units.", variant: "destructive" });
    return;
  }
                            ...
                            <div className="space-y-1.5">
                                ...
                                >
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <Label htmlFor="tn" className="text-xs font-medium cursor-pointer">Tamil Nadu</Label>
                                    </div>
                                    <div className="flex items-center space-x-2">
                                        <RadioGroupItem value="karnataka" id="ka" className="border-primary text-primary" />
                                        <Label htmlFor="ka" className="text-xs font-medium cursor-pointer">Karnataka</Label>
                                    </div>
                                </RadioGroup>
                            </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Popover>
                                    <PopoverTrigger asChild>
                                        ...
                                        >
                                            <CalendarIcon className="mr-2 h-4 w-4" />
                                            {resumeDate ? format(resumeDate, "P") : <span>Pick resume date</span>}
                                        </Button>
                                    </PopoverTrigger>
                                    <PopoverContent className="w-auto p-0">
                                        <Calendar
