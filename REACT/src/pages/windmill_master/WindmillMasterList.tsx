    ...
    const exportToExcel = () => {
        ...
        for (const row of rows) {
            const line = [
                ...
                row.windmill_capacity ?? row.capacity ?? row.kva_id ?? "",
                            ...
                            <Table>
                                <TableHeader className="bg-sidebar">
                                    <TableRow>
                                        ...
                                        <TableHead className="py-2 h-10 font-semibold text-white whitespace-nowrap">KVA Capacity</TableHead>
                                    ...
                                    {loading ? (
                                        ...
                                        filteredData.map((row, index) => (
                                            <TableRow key={index} className="hover:bg-slate-50 bg-white">
                                                ...
                                                <TableCell className="py-2 text-slate-600 text-sm">{row.windmill_capacity ?? row.capacity ?? row.kva_id}</TableCell>
