    ...
    React.useEffect(() => {
        ...
        const loadWindmill = async () => {
            ...
            try {
                ...
                setKvaId(data.kva_id ? String(data.kva_id) : "");
                ...
                setEdcCircle(data.edc_circle_id ? String(data.edc_circle_id) : "");
                if (data.kva_id) {
                    applyTransmissionLossFromKva(String(data.kva_id));
                } else {
                    setTransactionLoss(data.transmission_loss ? String(data.transmission_loss) : "0.00");
                }
                setMinimumLevelGeneration(data.minimum_level_generation ? String(data.minimum_level_generation) : "");
                setPortalUrl(data.open_access_portal || "");
                setPortalUsername(data.portal_username || "");
                setPortalPassword(data.portal_password || "");
