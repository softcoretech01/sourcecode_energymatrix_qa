...
export default function ConsumptionChargesEdit() {
    ...
    const [uom, setUom] = useState<string>("per_unit");
    const [type, setType] = useState<string>("unit");
                    ...
                    <div className="space-y-6 px-4 pt-2">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input defaultValue={id || "CHG-001"} className="bg-white border-slate-300 h-9 text-xs" />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-sm font-semibold text-slate-700">Charge Name</label>
                                <Input defaultValue="Maintenance Fee" className="bg-white border-slate-300 h-9 text-xs" />
                            </div>
                            <div className="space-y-1.5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input defaultValue="Monthly maintenance" className="bg-white border-slate-300 h-9 text-xs" />
                            </div>
                            <div className="space-y-1.5">
                                ...
                                <Popover>
                                    <PopoverTrigger asChild>
                                        ...
                                        >
                                            ...
                                            {date ? format(date, "P") : <span className="text-xs text-slate-400">01-01-2024</span>}
                                        </Button>
                                    </PopoverTrigger>
                            ...
                            <div className="space-y-1.5 flex flex-col">
                                ...
                                <div className="flex gap-2">
                                    <Input defaultValue="" placeholder="Enter Discount Charges" className="flex-1 bg-white border-slate-300 h-9 text-xs" />
                                    <Button
                                        type="button"
                                        variant="outline"
                                        size="sm"
