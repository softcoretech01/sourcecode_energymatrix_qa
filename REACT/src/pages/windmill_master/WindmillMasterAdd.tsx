    ...
    const saveWindmill = async (isSubmitted: boolean) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (data.id && documents.some((d) => d.file)) {
                ...
                alert(data.message || "Windmill saved successfully");
                                            ...
                                            <Popover>
                                                <PopoverTrigger asChild>
                                                    ...
                                                    >
                                                        ...
                                                        {fromDate ? format(fromDate, "P") : <span className="text-xs text-slate-400">Pick a date</span>}
                                                    </Button>
                                                </PopoverTrigger>
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <Popover>
                                                <PopoverTrigger asChild>
                                                    ...
                                                    >
                                                        <CalendarIcon className="mr-2 h-3 w-3" />
                                                        {toDate ? format(toDate, "P") : <span className="text-xs text-slate-400">Pick a date</span>}
                                                    </Button>
                                                </PopoverTrigger>
                                                <PopoverContent className="w-auto p-0">
                                                    <Calendar
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <Popover>
                                                <PopoverTrigger asChild>
                                                    ...
                                                    >
                                                        <CalendarIcon className="mr-2 h-3 w-3" />
                                                        {insuranceFromDate ? format(insuranceFromDate, "P") : <span className="text-xs text-slate-400">Pick a date</span>}
                                                    </Button>
                                                </PopoverTrigger>
                                                <PopoverContent className="w-auto p-0">
                                                    <Calendar
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <Popover>
                                                <PopoverTrigger asChild>
                                                    ...
                                                    >
                                                        <CalendarIcon className="mr-2 h-3 w-3" />
                                                        {insuranceToDate ? format(insuranceToDate, "P") : <span className="text-xs text-slate-400">Pick a date</span>}
                                                    </Button>
                                                </PopoverTrigger>
                                                <PopoverContent className="w-auto p-0">
                                                    <Calendar
